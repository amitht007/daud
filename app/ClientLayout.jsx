...
export default function ClientLayout({ children }) {
  ...
  const handleMobileSidebarToggle = () => setIsMobileOpen(!isMobileOpen)
  const handleMobileSidebarClose = () => setIsMobileOpen(false)

  return (
    <html lang="en">
      <body className="font-['Inter',system-ui,sans-serif] bg-slate-900 min-h-screen text-slate-100 antialiased">
        <SessionProvider> {/* ✅ Required for next-auth */}
          <AuthProvider> {/* Optional - if you're using custom logic */}
