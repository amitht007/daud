    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          ...
          <Card onClick={() => router.push("/podxs/onboard")} className="cursor-pointer hover:shadow transition-shadow">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
          ...
          <Card onClick={() => router.push("/podxs/manage")} className="cursor-pointer hover:shadow transition-shadow">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
          ...
          <Card onClick={() => router.push("/podxs/logs")} className="cursor-pointer hover:shadow transition-shadow">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
